...
// var addLink = (dagNode, [name, key]) => dagNode.addLink(name, key)
// var addUnnamedLink = (dagNode, key) => dagNode.addLink('', key)
// var buildDagObjFromSet = R.compose(R.sort, R.reduce(addUnnamedLink, new DagObject()))
...
export class IPFSNode {
  ...
  toDagObject(ipfsClient) {
    console.log('toDagObject', this.data, this.links.toJS())
    var obj = new DagObject(this.data)
