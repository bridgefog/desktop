...
var coreDevPublicKeys = [
  fs.readFileSync(path.resolve(__dirname, './core-dev/key1.pub')),
  fs.readFileSync(path.resolve(__dirname, './core-dev/key2.pub')),
  fs.readFileSync(path.resolve(__dirname, './core-dev/key3.pub')),
]
